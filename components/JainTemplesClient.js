        ...
        >
            ...
            <section className="fort-hero">
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="hero-title">{t("jain.hero.title")}</motion.h1>
            ...
            <main className="fort-main">
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title">{t("jain.section.overview")}</motion.h2>
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title">{t("jain.section.satbees")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                    ...
                    <div className="glass-panel" style={{ textAlign: 'center' }}>
                        ...
                        >
                            {playingAudio === 'satbees' ? <Waveform /> : <Play size={24} fill="currentColor" />}
                            <span style={{ fontWeight: 800, letterSpacing: '2px', textTransform: 'uppercase' }}>
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title">{t("jain.section.architecture")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                    <div className="glass-panel" style={{ textAlign: 'center' }}>
                        <motion.p variants={itemVariants} className="lead-para" style={{ color: '#fff !important', fontSize: '1.25rem' }}>
                ...
                >
                    <div className="section-inner" style={{ textAlign: 'center' }}>
                        <motion.h2 variants={itemVariants} className="section-title" style={{ fontSize: '1.8rem' }}>{t("jain.references.title")}</motion.h2>
