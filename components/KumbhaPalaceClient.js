...
export default function KumbhaPalaceClient() {
    ...
    const ARCH_FEATURES = [
        { id: "kumbha_arch.stables", icon: <Box size={20} /> },
        { id: "kumbha_arch.temple", icon: <Gem size={20} /> },
        { id: "kumbha_arch.cellars", icon: <Flame size={20} /> }
    ];
                    ...
                    <div className="overview-grid">
                        ...
                        <div className="overview-sidebar">
                            <div style={{ width: '100%', aspectRatio: '16/10', borderRadius: '16px', overflow: 'hidden', marginBottom: '2rem', border: '1px solid rgba(212,175,55,0.2)' }}>
                                <img src="/Each page Pics/Fort pics/Rana Kumbha Palace.jpg" alt={t("kumbha.hero.title")} style={{ width: '100%', height: '100%', objectFit: 'cover' }} />
                            </div>
                            <GoldenHourTracker />
                        </div>
                    </div>
