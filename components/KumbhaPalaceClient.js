...
export default function KumbhaPalaceClient() {
    ...
    const SECTIONS = [
        { id: "overview", label: t("kumbha.nav.overview"), icon: <Shield size={18} /> },
        { id: "history", label: t("kumbha.nav.history"), icon: <History size={18} /> },
        { id: "architecture", label: t("kumbha.nav.architecture"), icon: <ScrollText size={18} /> },
    ];

    const ARCH_FEATURES = [
        { id: "kumbha_arch.stables", icon: "🐎", image: "/Each page Pics/Fort pics/Rana Kumbha Palace.jpg" },
        { id: "kumbha_arch.temple", icon: "🛕", image: "/Each page Pics/Fort pics/Rana Kumbha Palace.jpg" },
        { id: "kumbha_arch.cellars", icon: "🕯️", image: "/Each page Pics/Fort pics/Rana Kumbha Palace.jpg" }
    ];
    ...
    return (
        ...
        >
            ...
            <section className="fort-hero">
                <div className="hero-bg" style={{ backgroundImage: "url('/Each page Pics/Fort pics/Rana Kumbha Palace.jpg')", backgroundPosition: 'center center' }}></div>
                ...
                >
                    ...
                    <span className="hero-eyebrow">{t("kumbha.hero.eyebrow")}</span>
                    <h1 className="hero-title">{t("kumbha.hero.title")}</h1>
                    <p className="hero-desc">{t("kumbha.hero.desc")}</p>
                    
                    <div className="hero-stats">
                        <div className="stat-item">
                            <span className="stat-val">15th</span>
                            <span className="stat-label">{t("kumbha.stats.built").split(' ').slice(1).join(' ')}</span>
                        </div>
                        <div className="stat-divider"></div>
                        <div className="stat-item">
                            <span className="stat-val">Royal</span>
                            <span className="stat-label">{t("kumbha.stats.type").split(' ').slice(1).join(' ')}</span>
                        </div>
                        <div className="stat-divider"></div>
                        <div className="stat-item">
                            <span className="stat-val">Massive</span>
                            <span className="stat-label">{t("kumbha.stats.feature").split(' ').slice(1).join(' ')}</span>
                        </div>
                    </div>
            ...
            <main className="fort-main">
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold">{t("kumbha.section.overview")}</h2>
                        <div className="title-divider"></div>
                    </div>
                    <div className="overview-grid">
                        <div className="overview-text">
                            <p className="lead-para">{t("kumbha.overview.p1")}</p>
                            ...
                            <button 
                                ...
                                onClick={() => handleAudioPlay('overview', `${t("kumbha.overview.p1")} ${t("kumbha.overview.p2")}`)}
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold">{t("kumbha.section.history")}</h2>
                        <div className="title-divider"></div>
                    </div>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="timeline-item">
                                <div className="timeline-img-wrapper">
                                    <img src="/Each page Pics/Fort pics/Rana Kumbha Palace.jpg" alt={t(`kumbha.history.era${i}.title`)} className="timeline-img" />
                                </div>
                                <div className="timeline-content">
                                    <h3 className="timeline-year">{t(`kumbha.history.era${i}.year`)}</h3>
                                    <h4 className="timeline-title">{t(`kumbha.history.era${i}.title`)}</h4>
                                    <p>{t(`kumbha.history.era${i}.desc`)}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <section id="architecture" className="fort-section">
                    ...
                    >
                        <h2 className="section-title text-gold">{t("kumbha.section.architecture")}</h2>
                        <div className="title-divider"></div>
                    </motion.div>
