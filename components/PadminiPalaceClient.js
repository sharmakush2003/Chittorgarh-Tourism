...
export default function PadminiPalaceClient() {
    ...
    const SECTIONS = [
        { id: "overview", label: t("padmini.nav.overview"), icon: <Shield size={18} /> },
        { id: "history", label: t("padmini.nav.history"), icon: <History size={18} /> },
        { id: "architecture", label: t("padmini.nav.architecture"), icon: <ScrollText size={18} /> },
    ];

    const ARCH_FEATURES = [
        { id: "padmini_arch.pool", icon: "🌸", image: "/Each page Pics/Fort pics/Padmini Palace.jpg" },
        { id: "padmini_arch.pavilion", icon: "🏛️", image: "/Each page Pics/Fort pics/Padmini Palace.jpg" },
        { id: "padmini_arch.zenana", icon: "👸", image: "/Each page Pics/Fort pics/Padmini Palace.jpg" }
    ];
    ...
    return (
        ...
        >
            ...
            <section className="fort-hero">
                <div className="hero-bg" style={{ backgroundImage: "url('/Each page Pics/Fort pics/Padmini Palace.jpg')", backgroundPosition: 'center center' }}></div>
                ...
                >
                    ...
                    <span className="hero-eyebrow">{t("padmini.hero.eyebrow")}</span>
                    <h1 className="hero-title">{t("padmini.hero.title")}</h1>
                    <p className="hero-desc">{t("padmini.hero.desc")}</p>
                    
                    <div className="hero-stats">
                        <div className="stat-item">
                            <span className="stat-val">14th</span>
                            <span className="stat-label">{t("padmini.stats.built").split(' ').slice(1).join(' ')}</span>
                        </div>
                        <div className="stat-divider"></div>
                        <div className="stat-item">
                            <span className="stat-val">Summer</span>
                            <span className="stat-label">{t("padmini.stats.type").split(' ').slice(1).join(' ')}</span>
                        </div>
                        <div className="stat-divider"></div>
                        <div className="stat-item">
                            <span className="stat-val">Lotus</span>
                            <span className="stat-label">{t("padmini.stats.feature").split(' ').slice(1).join(' ')}</span>
                        </div>
                    </div>
            ...
            <main className="fort-main">
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold">{t("padmini.section.overview")}</h2>
                        <div className="title-divider"></div>
                    </div>
                    <div className="overview-grid">
                        <div className="overview-text">
                            <p className="lead-para">{t("padmini.overview.p1")}</p>
                            <p>{t("padmini.overview.p2")}</p>
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold">{t("padmini.section.history")}</h2>
                        <div className="title-divider"></div>
                    </div>
                        ...
                        {[1, 2, 3].map((i) => (
                            <div key={i} className="timeline-item">
                                <div className="timeline-img-wrapper">
                                    <img src="/Each page Pics/Fort pics/Padmini Palace.jpg" alt={t(`padmini.history.era${i}.title`)} className="timeline-img" />
                                </div>
                                <div className="timeline-content">
                                    <h3 className="timeline-year">{t(`padmini.history.era${i}.year`)}</h3>
                                    <h4 className="timeline-title">{t(`padmini.history.era${i}.title`)}</h4>
                                    <p>{t(`padmini.history.era${i}.desc`)}</p>
                                </div>
                            </div>
                        ))}
                    </div>
                ...
                <section id="architecture" className="fort-section">
                    ...
                    >
                        <h2 className="section-title text-gold">{t("padmini.section.architecture")}</h2>
                        <div className="title-divider"></div>
                    </motion.div>
