                    ...
                    <div className="overview-grid">
                        <div className="overview-text">
                            ...
                            <button 
                                ...
                                onClick={() => handleAudioPlay('overview', ['nagari.overview.p1', 'nagari.overview.p2'])}
                    ...
                    <div className="overview-grid">
                        <div className="overview-text">
                            ...
                            <button 
                                ...
                                onClick={() => handleAudioPlay('sibi', ['nagari.sibi.p1', 'nagari.sibi.p2'])}
                                style={{ marginTop: '2rem' }}
                            >
                            ...
                            >
                                <div className="mon-content">
                                    ...
                                    <button 
                                        ...
                                        onClick={() => handleAudioPlay(m.id, [`nagari.attractions.${m.id}.name`, `nagari.attractions.${m.id}.desc`])}
                                    >
