...
export default function MeeraBaiTempleClient() {
        ...
        >
            ...
            <section className="fort-hero">
                <motion.div 
                    style={{ 
                        scale: heroScale,
                        backgroundImage: "url('/Each page Pics/Fort pics/Meera Bai Temple.jpg')" 
                    }} 
                    className="hero-bg"
                ></motion.div>
                ...
                >
                    ...
                    <motion.span variants={itemVariants} className="hero-eyebrow">{t("meera.hero.eyebrow")}</motion.span>
                    <motion.h1 variants={itemVariants} className="hero-title aura-heading">{t("meera.hero.title")}</motion.h1>
                    <motion.p variants={itemVariants} className="hero-desc">
                        {t("meera.hero.desc")?.split('. ').map((sentence, idx) => (
                            <motion.span 
                                key={idx} 
                                variants={sentenceVariants}
                                style={{ display: 'inline-block', marginRight: '0.4em' }}
                            >
                                {sentence}{idx < t("meera.hero.desc").split('. ').length - 1 ? '.' : ''}
                            </motion.span>
                        ))}
                    </motion.p>
                </motion.div>
            ...
            <nav className="section-nav">
                <div className="nav-container">
                    <a href="#overview">{t("meera.nav.overview")}</a>
                    <a href="#architecture">{t("meera.nav.architecture")}</a>
                </div>
            </nav>
            ...
            <main className="fort-main">
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title aura-heading">{t("meera.section.overview")}</motion.h2>
                    ...
                    <div className="glass-panel" style={{ textAlign: 'center' }}>
                        ...
                        <motion.div 
                            ...
                            onClick={() => handleAudioPlay('overview', 'meera.overview.p1')}
                        >
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title aura-heading">{t("meera.section.architecture")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                    <div className="glass-panel" style={{ textAlign: 'center' }}>
                        ...
                        <motion.div 
                            ...
                            onClick={() => handleAudioPlay('architecture', 'meera.architecture.p1')}
                        >
                ...
                >
                    <div className="section-inner" style={{ textAlign: 'center' }}>
                        <motion.h2 variants={itemVariants} className="section-title" style={{ fontSize: '2.5rem' }}>{t("meera.references.title")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider" style={{ width: '80px', marginBottom: '4rem' }}></motion.div>
                        
                        <motion.a 
                            variants={itemVariants}
                            href={t("meera.references.official_url")} 
                            target="_blank" 
