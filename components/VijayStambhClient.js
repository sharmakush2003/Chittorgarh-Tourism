        ...
        >
            ...
            <section className="fort-hero">
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="hero-title">{t("vijay.hero.title")}</motion.h1>
            ...
            <main className="fort-main">
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title">{t("vijay.section.history")}</motion.h2>
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title">{t("vijay.section.architecture")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                    ...
                    <div className="architecture-showcase" style={{ marginBottom: '4rem' }}>
                        ...
                        >
                            <img 
                                src="/images/vijay-stambh-arch.jpg" 
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title">{t("vijay.section.experience")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                    <div className="glass-panel" style={{ textAlign: 'center' }}>
                        <motion.p variants={itemVariants} style={{ color: '#fff !important' }}>
                ...
                >
                    <div className="section-inner" style={{ textAlign: 'center' }}>
                        <motion.h2 variants={itemVariants} className="section-title" style={{ fontSize: '1.8rem' }}>{t("vijay.references.title")}</motion.h2>
