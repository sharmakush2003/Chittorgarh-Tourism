    ...
    return (
        ...
        >
            ...
            <section className="fort-hero">
                <div className="hero-bg" style={{ backgroundImage: "url('/Each page Pics/Fort pics/Vijay Stambh.jpg')", backgroundPosition: 'center center' }}></div>
                ...
                >
                    ...
                    <span className="hero-eyebrow">{t("vijay.hero.eyebrow")}</span>
            ...
            <nav className="section-nav">
                <div className="nav-container">
                    <a href="#history">{t("vijay.nav.history")}</a>
                    <a href="#architecture">{t("vijay.nav.architecture")}</a>
                    <a href="#experience">{t("vijay.nav.experience")}</a>
                </div>
            </nav>
            ...
            <main className="fort-main">
                ...
                >
                    ...
                    <div className="overview-text">
                        <p className="lead-para">{t("vijay.history.p1")}</p>
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold">{t("vijay.section.architecture")}</h2>
                        <div className="title-divider"></div>
                    </div>
                    <div className="overview-text">
                        <p>{t("vijay.architecture.p1")}</p>
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold">{t("vijay.section.experience")}</h2>
                        <div className="title-divider"></div>
                    </div>
                    <div className="overview-text">
                        <p>{t("vijay.experience.p1")}</p>
                        
                        <button 
                            className={`audio-btn ${playingAudio === 'experience' ? 'playing' : ''}`}
                            onClick={() => handleAudioPlay('experience', 'vijay.experience.p1')}
                            style={{ marginTop: '2rem' }}
                        >
                            {playingAudio === 'experience' ? <Pause size={18} fill="currentColor" /> : <Play size={18} fill="currentColor" />}
                            <span>{playingAudio === 'experience' ? t("fort.audio.playing") : t("fort.audio.listen")}</span>
                        </button>
                    </div>
                </motion.section>
                {/* ═══ REFERENCES ═════════════════════════════ */}
                ...
                >
                    <div className="section-header">
                        <h2 className="section-title text-gold" style={{ fontSize: '1.5rem' }}>{t("vijay.references.title")}</h2>
