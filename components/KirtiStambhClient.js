        ...
        >
            ...
            <section className="fort-hero">
                ...
                >
                    ...
                    <motion.h1 variants={itemVariants} className="hero-title aura-heading">{t("kirti.hero.title")}</motion.h1>
            ...
            <main className="fort-main">
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title aura-heading">{t("kirti.section.history")}</motion.h2>
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title aura-heading">{t("kirti.section.architecture")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                ...
                >
                    <div className="section-header">
                        <motion.h2 variants={itemVariants} className="section-title aura-heading">{t("kirti.section.temples")}</motion.h2>
                        <motion.div variants={itemVariants} className="title-divider"></motion.div>
                    </div>
                    <div className="glass-panel" style={{ textAlign: 'center' }}>
                        <motion.p variants={itemVariants} style={{ color: '#fff !important', fontSize: '1.25rem' }}>
                        ...
                        >
                            ...
                            <span style={{ fontWeight: 800, letterSpacing: '3px', textTransform: 'uppercase', fontSize: '1rem' }}>
                                {playingAudio === 'temples' ? (t("fort.audio.playing") || "Playing") : (t("fort.audio.listen") || "Listen Narrative")}
                            </span>
                        </motion.div>
                    </div>
                </motion.section>
