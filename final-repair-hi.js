...
const tempPath = path.join(__dirname, 'public', 'translations', 'hi_new.json');
...
fs.writeFileSync(tempPath, JSON.stringify(final, null, 4));
fs.renameSync(tempPath, hiPath);
console.log('Renamed clean hi.json successfully.');
